...
#define atanf stdc::stdc_3C057FBD

		double stdc_31DB8C89(double y, double x);                                      // atan2()
#define atan2 stdc::stdc_31DB8C89

		float stdc_FB932A56(float y, float x);                                         // atan2f()
#define atan2f stdc::stdc_FB932A56

		float stdc_ABDCCC7A(float, float);                                             // f_atan2f()
#define f_atan2f stdc::stdc_ABDCCC7A
...
#define wcstoll stdc_A30D4797
		...
		static const char* va(const char* fmt, ...)
		{
			va_list args;
			va_start(args, fmt);
			vsnprintf(vaBuffer, 0x400, fmt, args);
			va_end(args);
			return vaBuffer;
		}
